...
Here is an example of a terminal card. Note that GitHub will not render the custom styles or interactive parts.
            ...
            <div class="terminal">
                <hgroup class="head">
                    ...
                    <button class="copy_toggle" tabindex="-1" type="button">
                        ...
                        >
                            <path
                                d="M15 10L19 14M19 10L15 14M3 6L3 10M3 6L7 10M7 6L3 10M7 6L7 10M13 6L13 10M13 6L13 10M3 16L7 20M7 16L3 20M7 16L13 16M13 16L19 20M19 16L13 20"
                            ></path>
                        </svg>
                    </button>
                </hgroup>
                <div class="body">
                    <pre class="pre">
                        <code class="cmd" data-cmd="> [1/2] NPM INSTALL">npm install</code>
                        <code class="cmd" data-cmd="> [2/2] NPM RUN BUILD">npm run build</code>
                    </pre>
                </div>
            </div>
        </div>
